...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_OC4DeepCwindSemi_ElastoDyn_fixed_no_offset.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../SeaStSim/NRELOffshrBsline5MW_OC4DeepCwindSemi_SeaState_WaveMod6.dat"    SeaState       - Name of file containing sea state input parameters (quoted string)
"../HDSim/NRELOffshrBsline5MW_OC4DeepCwindSemi_HydroDyn.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
...
FALSE         TabDelim        - Use tab delimiters in text tabular output file? (flag) {uses spaces if false}
